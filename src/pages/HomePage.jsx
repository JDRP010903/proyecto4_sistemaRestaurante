...
const HomePage = () => {
    return (
        <>
            ...
            <div className="row">
                <h4 className="descripcionh4 col-12 col-lg-6">Un restaurante jardín único. Con un ambiente agradable y temáticas que van de acuerdo a las fechas</h4>
                <h4 className="descripcionh4 col-12 col-lg-6">Un lugar que te hace sentir en casa, con amor en cada platillo y calidad en cada cucharada</h4>
            </div>
            ...
            <div className="row" >
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3757.0409093017497!2d-99.2316005!3d19.66826!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d21f56715bf38f%3A0xcf26e2dc5052ce60!2sRestaurante%20%22Los%20Rosales%22!5e0!3m2!1ses!2smx!4v1706404791633!5m2!1ses!2smx" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </>
    )
}
